...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        /*
        // TODO: Properly instantiate the VC if this gets triggered
        let ourDefaults = UserDefaults.standard
        if let displayName = ourDefaults.object(forKey: "displayName") as? String {
            ...
            let callData = CallData(displayName: displayName)
            addViewController.callData = callData
